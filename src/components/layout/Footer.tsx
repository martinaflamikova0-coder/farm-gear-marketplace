        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <a href="mailto:info@geoitalyagro.com" className="flex items-center gap-3 text-sm text-primary-foreground/70 hover:text-primary-foreground transition-colors group">
                <div className="w-8 h-8 rounded-full bg-primary-foreground/10 flex items-center justify-center group-hover:bg-primary-foreground/20 transition-colors">
